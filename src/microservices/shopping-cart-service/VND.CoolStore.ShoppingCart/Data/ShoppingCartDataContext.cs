    ...
    public class ShoppingCartDataContext : AppDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductCatalog>().HasData(
                ProductCatalog.Load(NewId("05233341-185A-468A-B074-00EBD08559AA"), "tempor incididunt ut labore et do", 638, "quis nostrud exercitation ull"),
                ProductCatalog.Load(NewId("3CB275C5-AA53-40FF-BC6A-015327053AF9"), "m", 671, "sin")
                );
        }
    }
}
